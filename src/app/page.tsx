    ...
    <main className='flex min-h-screen items-center justify-center'>
      ...
      <div className='fixed sm:bottom-10 lg:bottom-20 xl:bottom-24 bottom-16'>
        ...
        >
          ...
          <span className='absolute inset-0 w-full h-full transition-all duration-200 ease-out rounded-3xl shadow-xl bg-gradient-to-br filter group-active:opacity-0 group-hover:blur-sm from-amber-600 to-yellow-500'></span>
